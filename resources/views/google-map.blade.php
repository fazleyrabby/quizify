...
<body>
    <div class="col-lg-8 mx-auto p-4 py-md-5">
        ...
        <main>
            ...
            <hr>
            <div class="mb-3 row position-relative"></div>
    ...
    <input type="hidden" id="googleMapKey" value="{{ env('GOOGLE_MAP_API') }}">

    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script src="https://unpkg.com/maplibre-gl@latest/dist/maplibre-gl.js"></script>

    <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key={{ env('GOOGLE_MAP_API') }}&callback=initMap" async defer></script>
    <script src="{{ asset('frontend/gmap.js') }}"></script>
